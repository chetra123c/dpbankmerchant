...
class unreachedList extends StatefulWidget {
  const unreachedList({super.key});

  @override
  State<unreachedList> createState() => _unreachedListState();
}

class _unreachedListState extends State<unreachedList> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          backgroundColor: painColor,
          title:const Text(Unreached),
